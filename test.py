...
def train(train_data_dir, model_dir, **kwargs):
    ...
    net = create_regnet(model_name="RegNetX_400MF", num_classes=5).to(device)
    # load model weights
    ...
    save_path = './Regnet_train_new.pth'
    best_acc = 0.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', default='./model/weights/model-9.pth', help='the pre-trained model')
